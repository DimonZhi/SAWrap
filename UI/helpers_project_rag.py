...
FOUNDATION_REQUIRED_SECTIONS = [
    ...
    ("knowledge/thesis_summary.md", "Постановки задачи"),
    ("knowledge/thesis_summary.md", "Научная новизна"),
    ("knowledge/thesis_summary.md", "Единое представление прогнозов"),
    ("knowledge/thesis_summary.md", "Функциональные сценарии работы"),
    ("knowledge/project_context.md", "Сценарии использования"),
    ("knowledge/piecewise_times.md", "Piecewise-times расширение"),
    ("knowledge/piecewise_times.md", "Результаты по classification score"),
    ("knowledge/experiments_summary.md", "Датасеты"),
