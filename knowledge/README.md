...
Эта папка содержит сжатую базу знаний проекта SAWrap. Ее цель - дать LLM контекст о дипломной работе, коде, экспериментах, продуктовой идее и типичных вопросах жюри без fine-tuning модели.
...
- как проект выглядит с точки зрения разработки, MLOps, продукта и конкурса.
